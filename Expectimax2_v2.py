...
class Node:
    def __init__(self, grid, score, agent_depth, max_depth, node_type, t, position=None):
        self.grid = grid
        self.score = score
    ...
    def evaluation(self):
        ...
        if self.node_type == "Max":
            ...
            for g in possible_action:
                child_node = Node(g[0], new_score, self.agent_depth, self.max_depth, "Min", self.t)
            ...
            for i in range(tiles):
                ...
                child_node = Node(new_grid, self.score, self.agent_depth, self.max_depth, "Chance", self.t, new_position)
                child_score, scn_c = child_node.evaluation()
            ...
            for i in range(2):
                ...
                child_node = Node(new_grid, self.score, self.agent_depth+1, self.max_depth, "Max", self.t)
                child_score, scn_c = child_node.evaluation()
